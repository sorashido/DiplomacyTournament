...
public class TournamentRunner {
	...
	final static String[] DDAgent3_Command = {"java", "-jar", "out/artifacts/DDAgent3/DDAgent3.jar", "-log", "log", "-name", "DDAgent", "-fy", "1920"};
...
//						break;
					case 6:
						name = "DDAgent3_Command" + i;
						command = DDAgent3_Command;
						break;
				}
